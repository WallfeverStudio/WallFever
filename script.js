...
const postersData = [
    ...
    {
        id: 14,
        title: "Create Your Own - Custom Anime",
        category: "custom",
        price: "",
        image: "custom-anime-poster",
        description: "Design your own custom anime poster with our professional artists. Contact us for pricing and design consultation."
    },
    {
        id: 15,
        title: "Create Your Own - Custom Car",
        category: "custom",
        price: "",
        image: "custom-car-poster",
        description: "Design your own custom automotive poster with our professional artists. Contact us for pricing and design consultation."
    }
];
        ...
        return `
            <div class="poster-item custom-poster" data-category="${poster.category}">
                ...
                <div class="poster-info">
                    <button class="btn btn-primary custom-bottom-btn" onclick="redirectToInstagram()" style="background: #ff6b6b; color: white; border: none; padding: 15px; font-size: 16px; font-weight: bold; cursor: pointer;">
            ...
            <div class="poster-item" data-category="${poster.category}">
                <div class="poster-image">
                    ...
                    <div class="poster-overlay">
                        <button class="btn btn-primary" onclick="redirectToInstagram()">
                            Buy Now
                        </button>
                    </div>
                </div>
